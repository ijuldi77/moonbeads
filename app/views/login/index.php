<main class="flex justify-center items-center font-poppins w-full min-h-screen bg-background text-headline mx-auto">
    <section class="w-[30rem] m-9 flex flex-col space-y-9">
        ...
        <form action="<?= BaseURL; ?>/login/masuk" method="post" class="w-full flex flex-col space-y-9">
            <div
            ...
            <button type="submit"
                class="bg-button p-2 text-white rounded-lg hover:bg-opacity-70 duration-300 font-bold">LOG
                IN</button>
        </form>
